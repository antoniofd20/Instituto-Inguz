<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        try {
            ...
            $statment2 = $conexion->prepare(
                "INSERT INTO $db.tbcolaborador
                (clavecolaborador, persona, area, profesion, fechalta)
                VALUES (?, ?, ?, ?, ?)"
            )or die("Error al insertar colaborador " . mysqli_error($conexion));

            $statment2->bind_param("iisss", $siguiente, $siguiente, $area, $profesion, $fecha_alta);
            $statment2->execute();

            $conexion->commit();

            echo "<script language = javascript>
            alert('Colaborador registrado con exito.');
    ...
    $titulo = 'Registro Colaborador';
    $retorno = 'colaboradores.php';
    #require 'views/form_colab.view.php';
    require '../../plantillas/nav_side.view.php';

?>

<div class="cont">
    <h1 class="title">Registrar nuevo colaborador</h1>
    ...
    <div class="main-container">
        <form action="form_colab.php" method="post">
          <div class="tabla-scroll-container-ver">
            <table class="tabla-consulta-modal-form">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="input matricula" name="edad" id="edad" title="Ingrese la edad del profesor">
                    </td>
                    -->
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <input required type="text" class="input" id="telefono" title="Ingrese el telefono" name="telefono">
                    </td>
                    <th>
                        <label for="celular" class="label">Celular:</label>
                    </th>
                    <td>
                        <input required type="text" class="input" id="celular" title="Ingrese el celular" name="celular">
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <input required type="text" class="input" id="cp" title="Ingrese su codigo postal"  name="cp">
                   </td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input required type="text" class="input" name="profesion" id="profesion" title="Ingrese nivel de estudios alcanzado">
                    </td>
                </tr>
                <tr>
                    <th>
          ...
          <input required type="submit" value="Registrar colaborador" class="submit">
        </form>
    </div>
</div>