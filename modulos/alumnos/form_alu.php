...
<div class="cont">
    <h1 class="title">Registrar nuevo alumno</h1>
          ...
          <div class="tabla-scroll-container-ver">
            <table class="tabla-consulta-modal-form">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="input matricula" name="grupo" placeholder="6453..." id="grupo">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="input" name="nombre" id="nombre" title="Ingrese el nombre del alumno">
                    </td>
                    <th>
                        <label for="ap_paterno" class="label">Apellido paterno:</label>
                    </th>
                    <td>
                        <input type="text" class="input" name="ap_paterno" id="ap_paterno" title="Ingrese el apellido paterno">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" class="input" name="ap_materno" id="ap_materno" title="Ingrese el apellido materno">
                    </td>
                    <th>
                        <label for="curp" class="label">Curp:</label>
                    </th>
                    <td>
                        <input type="text" class="input" name="curp" id="curp" title="Ingrese el curp del alumno">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="number" class="input matricula" name="edad" id="edad" title="Ingrese la edad del alumno">
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="input" id="celular" title="Ingrese el celular" name="celular">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="number" class="input" id="recados" title="Ingrese un numero para recados" name="recados">
                    </td>
                    <th>
                        <label for="email" class="label">Correo eléctronico:</label>
                    </th>
                    <td>
                        <input type="email" class="input" id="email" title="Ingrese correo electronico" name="email">
                    </td>
                </tr>
                <!-- DOMICILIO -->
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="input" id="calle_num" title="Ingrese la calle y numero" name="calle_num">
                    </td>
                    <th>
                        <label for="colonia" class="label">Colonia:</label>
                    </th>
                    <td>
                        <input type="text" class="input" id="colonia" title="Ingrese la colonia" name="colonia">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="text" class="input" id="alc_mun" title="Ingrese su alcaldia o municipio" name="alc_mun">
                    </td>
                    <th>
                        <label for="estado_r" class="label">Estado:</label>
                    </th>
                    <td>
                        <input type="text" class="input" id="estado_r" title="Ingrese el estado al que pertenece"  name="estado_r">
                   </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="number" class="input" id="cp" title="Ingrese su codigo postal"  name="cp">
                   </td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="acta" id="acta" title="Acta de nacimiento">
                    </td>
                    <th>
                        <label for="curp_checkbox">Curp:</label>
                    </th>
                    <td>
                        <input type="checkbox" name="curp_checkbox" id="curp_checkbox" title="Curp">
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <input type="checkbox" name="ine" id="ine" title="INE">
                    </td>
                </tr>
            </table>
          </div>
